...
export default function ChapterScreen() {
  const { currentBook, currentChapter, isLoading, error, addToFavorites, isFavorite } = useBible()
      ...
      <View style={styles.verseContainer}>
        ...
        {isSelected && (
          <View style={styles.verseActions}>
            ...
            >
              <ThemedText style={styles.favoriteIcon}>{isFav ? '❤️' : '🤍'}</ThemedText>
      ...
      <ThemedView style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.headerCenter}>
            ...
            <ThemedText style={styles.chapterNumber}>{currentChapter.chapter}</ThemedText>
          </View>
